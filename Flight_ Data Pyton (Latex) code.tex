...
\hline
\rowcolor{}
\textbf{Course Title} & Programming with R and Python \\ \hline
\textbf{Course Code} & STAT 2205\\ \hline
...
max = 580.85\\
\begin{center}
\includegraphics[width=0.8\textwidth]{Desktop/1.1.png}
\end{center}
\end{tcolorbox}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{JPG/3.1 P .png}
\end{center}
\end{tcolorbox}
...
\begin{tcolorbox}[colback=white]
\begin{center}
\includegraphics[width=0.8\textwidth]{Graphicx/4.1 p.png}
\end{center}
\begin{tabular}{p{4cm}p{4cm}p{4cm}}
\textbf{}       & miles & coach_price\\
\textbf{miles}  & 1.000000 & 0.372265\\
coach price & 0.372265  &  1.000000
\end{tabular}
\end{tcolorbox}
...
\begin{tcolorbox}[colback=whitee]
\begin{center}
\includegraphics[width=0.8\textwidth]{Graphicx/Q.5 P .png}
\end{center}
...
\begin{tcolorbox}[colback=white]
\begin{center}
\includegraphics[width=0.8\textwidth]{Graphicx/Q.6 P.png}
\end{center}
...
Non Weekend Coach Price = 323.04\\
Weekend frist class price = 1559.762531\\
Non Weekend first class price = 1258\begin{center}
\includegraphics[width=0.8\textwidth]{Graphicx/Graphicx1/8.png}
\end{center}
\end{tcolorbox}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{Graphicx/Graphicx1/9.png}
\end{center}
\end{tcolorbox}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{Graphicx/Graphicx1/10.2 v.png}

\includegraphics[width=0.8\textwidth]{Graphicx/Graphicx1/10.2.2 v.png}

\includegraphics[width=0.8\textwidth]{Graphicx/Graphicx1/10.2.3v.png}
\end{center}
%==================== HYPOTHESIS TEST ====================%
