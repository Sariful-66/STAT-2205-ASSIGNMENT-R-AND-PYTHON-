...
\begin{titlepage}
    ...
    {\Huge\bfseries \textcolor{titleblue}{Flight Data Analysis Programing with R }}\\[1cm]
    ...
    \begin{tabular}{|>{\bfseries}m{4cm}|m{8cm}|}
    \hline
    ...
    {\Huge\textbf{Begum Rokeya University}}\\[0.3cm]
...
\subsection{Output}
\begin{center}
 \includegraphics[width=0.80\textwidth]{Graphicx R/1.1 R.png}\\
 \end{center}
...
\subsection{Output}
\begin{center}
 \includegraphics[width=0.80\textwidth]{Graphicx R/3.0 R.png}\\
 \end{center}
\subsection{Interpretation}
...
\subsection{Output}
\begin{center}
 \includegraphics[width=0.80\textwidth]{Graphicx R/4.0 r.png}\\
 \end{center}
\subsection{Interpretation}
...
\subsection{Output}
\begin{center}
 \includegraphics[width=0.80\textwidth]{Graphicx R/5.0 R.png}\\
 \end{center}
\subsection{Interpretation}
...
\subsection{Output}
\begin{center}
 \includegraphics[width=0.80\textwidth]{Graphicx R/6.0 R.png}\\
 \end{center}
\subsection{Interpretation}
...
\subsection{Output}
\begin{center}
 \includegraphics[width=0.80\textwidth]{Graphicx R/8.0 R.png}\\
 \end{center}
\subsection{Interpretation}
...
\subsection{Output}
\begin{center}
 \includegraphics[width=0.80\textwidth]{Graphicx R/9.0 R.png}\\
 \end{center}
\subsection{Interpretation}
...
\subsection{Output}
\begin{center}
 \includegraphics[width=0.80\textwidth]{Graphicx R/10.1.png}\\[1cm]
 
 \includegraphics[width=0.80\textwidth]{Graphicx R/10.2.png}\\[1cm]

 \includegraphics[width=0.80\textwidth]{Graphicx R/10.3 R.png}\\
 \end{center}
